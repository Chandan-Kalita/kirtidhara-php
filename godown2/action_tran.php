...
if ($_POST['tran_type'] == 'stock_in') {
    ...
    // echo "insert into product_transaction(product_name, opening_stock, stock_in, dispatch, cancel, damage, closing, date) values('$product_name', '$opening', '$quantity', '0', '0', '0', $new_total_stock, '$date')";
    // die();

        $insert_query = mysqli_query($con, "insert into product_transaction(product_name, opening_stock, stock_in, dispatch, cancel, damage, closing, date) values('$product_name', '$opening', '$quantity', '0', '0', '0', $new_total_stock, '$date')");
    }
...
if ($_POST['tran_type'] == 'dispatch') {
    ...
    if ($res['total_stock'] < $quantity) {
        ...
        if (mysqli_num_rows($check) > 0) {
            ...
            $insert_query = mysqli_query($con, "insert into product_transaction(product_name, opening_stock, stock_in, dispatch, cancel, damage, closing, date) values('$product_name', '$opening', '0', '$quantity', '0', '0', $new_total_stock, '$date')");
        }
    }
}
...
if ($_POST['tran_type'] == 'cancel') {
    ...
    if (mysqli_num_rows($check) > 0) {
        ...
        $insert_query = mysqli_query($con, "insert into product_transaction(product_name, opening_stock, stock_in, dispatch, cancel, damage, closing, date) values('$product_name', '$opening', '0', '0','$quantity', '0', $new_total_stock, '$date')");
    }
}
...
if ($_POST['tran_type'] == 'damage') {
    ...
    if ($res['total_stock'] < $quantity) {
        ...
        if (mysqli_num_rows($check) > 0) {
            ...
            $insert_query = mysqli_query($con, "insert into product_transaction(product_name, opening_stock, stock_in, dispatch, cancel, damage, closing, date) values('$product_name', '$opening', '0', '0', '0','$quantity',  $new_total_stock, '$date')");
        }
    }
}
